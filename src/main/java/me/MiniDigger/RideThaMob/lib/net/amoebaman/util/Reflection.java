package me.MiniDigger.RideThaMob.lib.net.amoebaman.util;
...
public final class Reflection {
	...
	/**
	 * Gets a {@link Class} object representing a type contained within the {@code net.minecraft.server} versioned
	 * package.
	 * The class instances returned by this method are cached, such that no lookup will be done twice (unless multiple
	 * threads are accessing this method simultaneously).
	 *
	 * @param className
	...
	/**
	 * Gets a {@link Class} object representing a type contained within the {@code org.bukkit.craftbukkit} versioned
	 * package.
	 * The class instances returned by this method are cached, such that no lookup will be done twice (unless multiple
	 * threads are accessing this method simultaneously).
	 *
	 * @param className
	 *            The name of the class, excluding the package, within OBC. This name may contain a subpackage name,
	 *            such as {@code inventory.CraftItemStack}.
	 ...
	 * <p>
	 * The only match currently attempted by this method is a retrieval by using a parameterless {@code getHandle()}
	 * method implemented by the runtime type of the specified object.
	 * </p>
	 *
	 * @param obj
	 *            The object for which to retrieve an NMS handle.
	 * @return The NMS handle of the specified object, or {@code null} if it could not be retrieved using
	 *         {@code getHandle()}.
	 */
	 ...
	 * <p>
	 * A global caching mechanism within this class is used to store fields. Combined with synchronization, this
	 * guarantees that
	 * no field will be reflectively looked up twice.
	 * </p>
	 * <p>
	 * If a field is deemed suitable for return, {@link Field#setAccessible(boolean) setAccessible} will be invoked with
	 * an argument of {@code true} before it is returned.
	 * This ensures that callers do not have to check or worry about Java access modifiers when dealing with the
	 * returned instance.
	 * </p>
	 *
	 * @param clazz
	 ...
	 * returned will be an instance or static field.
	 * <p>
	 * A global caching mechanism within this class is used to store method. Combined with synchronization, this
	 * guarantees that
	 * no method will be reflectively looked up twice.
	 * </p>
	 * <p>
	 * If a method is deemed suitable for return, {@link Method#setAccessible(boolean) setAccessible} will be invoked
	 * with an argument of {@code true} before it is returned.
	 * This ensures that callers do not have to check or worry about Java access modifiers when dealing with the
	 * returned instance.
	 * </p>
	 * <p>
