package me.MiniDigger.RideThaMob.lib.mkremins.fanciful;

import static me.MiniDigger.RideThaMob.lib.mkremins.fanciful.TextualComponent.*;
...
import me.MiniDigger.RideThaMob.lib.net.amoebaman.util.ArrayWrapper;
import me.MiniDigger.RideThaMob.lib.net.amoebaman.util.Reflection;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	public FancyMessage achievementTooltip(final Achievement which) {
		try {
			final Object achievement = Reflection.getMethod(Reflection.getOBCClass("CraftStatistic"), "getNMSAchievement", Achievement.class).invoke(null,
					which);
	 ...
	 * @return This builder instance.
	 * @exception IllegalArgumentException
	 *                If the statistic requires a parameter which was not supplied, or was supplied a parameter that was
	 *                not required.
	 */
	public FancyMessage statisticTooltip(final Statistic which, final Material item) {
		...
		try {
			final Object statistic = Reflection.getMethod(Reflection.getOBCClass("CraftStatistic"), "getMaterialStatistic", Statistic.class, Material.class)
	...
	public FancyMessage statisticTooltip(final Statistic which, final EntityType entity) {
		...
		try {
			final Object statistic = Reflection.getMethod(Reflection.getOBCClass("CraftStatistic"), "getEntityStatistic", Statistic.class, EntityType.class)
	...
	public FancyMessage itemTooltip(final ItemStack itemStack) {
		try {
			final Object nmsItem = Reflection.getMethod(Reflection.getOBCClass("inventory.CraftItemStack"), "asNMSCopy", ItemStack.class).invoke(null,
					itemStack);
	...
	private Object createChatPacket(final String json) throws IllegalArgumentException, IllegalAccessException, InstantiationException,
