...
import static me.MiniDigger.RideThaMob.lib.mkremins.fanciful.TextualComponent.rawText;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	 ...
	 */
	public static FancyMessage deserialize(String json) throws MalformedJsonException{
