...
public class CoreBukkitCommand extends Command implements BukkitCommand {
	...
	public boolean execute(final CommandSender sender, final String commandLabel, final String[] args) {
		...
		try {
			...
			throw new CommandException("An error occured while executing command " + commandLabel, ex);
		}
	...
	public java.util.List<String> tabComplete(final CommandSender sender, final String alias, final String[] args)
		...
		try {
			...
			throw new CommandException("Exception while tab completing: " + message.toString(), ex);
		}
